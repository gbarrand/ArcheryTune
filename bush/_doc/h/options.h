...
@verbatim
 ...
 -parallel : if the GNU parallel application is known from your prompt, C and C++ file compilations
             are distributed on your cores. Tested only on macOS for the moment with a MacPorts
             installation of the parallel program. Since good part of the code of our apps is pure header,
             it will not boost the "main" part of them, but it clearly boosts the build of the
             ourex externals.
@endverbatim
