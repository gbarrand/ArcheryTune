...
#ifndef OUREX_GL2PS_NO_RENAME_GL
/* arrange to have gl2ps.c using dummy gl functions.
   It is the default since we do not use the gl2ps functions
   that uses OpenGL ! */
#define OUREX_GL2PS_RENAME_GL
#endif

#ifdef OUREX_GL2PS_NO_GL
/* see exlib/example/cpp/lego_batch.cpp */
...
#define GL_CURRENT_RASTER_COLOR  2
#define GL_COLOR_INDEX           3
#define GL_POINT_TOKEN           4
#define GL_LINE_TOKEN            5
#define GL_LINE_RESET_TOKEN      6
#define GL_POLYGON_TOKEN         7
#define GL_BITMAP_TOKEN          8
#define GL_DRAW_PIXEL_TOKEN      9
#define GL_COPY_PIXEL_TOKEN     10
#define GL_PASS_THROUGH_TOKEN   11
#define GL_FEEDBACK             12
#define GL_INDEX_CLEAR_VALUE    13
#define GL_RENDER               14
#define GL_LINE_STIPPLE_PATTERN 15
#define GL_LINE_STIPPLE_REPEAT  16
#define GL_3D_COLOR             17

GLint glRenderMode(GLenum a);
void glPassThrough(float a);
void glBegin();
...
GL2PSDLL_API GLint gl2psSetBackgroundColor(float r,float g,float b);
